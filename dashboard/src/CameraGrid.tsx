      ...
      >
        ...
        {cam.online && (
          <button
            ...
            title={showPTZ ? "Fechar controles PTZ" : "Abrir controles PTZ"}
            style={{
              background: showPTZ ? "#2563eb" : "transparent",
              border: showPTZ ? "1px solid #3b82f6" : "1px solid #374151",
              color: showPTZ ? "#fff" : "#9ca3af",
              borderRadius: 4,
              fontSize: 11,
              padding: "2px 8px",
              cursor: "pointer",
            ...
            >
              <span
                style={{
                  ...
                  borderRadius: "50%",
                  backgroundColor:
                    topAlert.severity >= 3 ? "#f59e0b" : "#3b82f6",
